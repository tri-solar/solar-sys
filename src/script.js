...
const createPlanet = (size, color, distance, parent = scene, storeForScale = true, name = '') => {
...
// terrestrial planets
const mercury = createPlanet(0.11, '#aaaaaa', 6.78, scene, true, 'Mercury')
const venus = createPlanet(0.174, '#b38c5f', 7.44, scene, true, 'Venus')
const earth = createPlanet(0.184, '#0077ff', 8, scene, true, 'Earth')
const mars = createPlanet(0.098, '#ff3300', 9.04, scene, true, 'Mars')

// earth's moon
const luna = createPlanet(0.05, '#888888', 0.3, earth, false, 'Moon')
...
// gas giants
const jupiter = createPlanet(2.024, '#7d4739', 16.4, scene, true, 'Jupiter')
const saturn = createPlanet(1.748, '#be9352', 25.08, scene, true, 'Saturn')
const uranus = createPlanet(0.736, '#7fffd4', 44.38, scene, true, 'Uranus')
const neptune = createPlanet(0.718, '#0000ff', 66.14, scene, true, 'Neptune')
